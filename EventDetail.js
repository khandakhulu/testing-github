...
import { FaLocationArrow, FaCalendar, FaCalendarAlt } from "react-icons/fa";
    ...
    <div className="flex flex-wrap md:flex-no-wrap justify-between p-6 mx-auto max-w-6xl">
      ...
      <div className="w-full md:w-1/2 h-90 bg-slate-100 p-6 rounded-r">
        <div className="flex flex-col gap-4 ">
          ...
          <div className="flex flex-row item-center text-gray-700">
          ...
          <div className="flex items-center text-gray-700">
            <FaLocationArrow className="mr-2 text-3xl" />
            {location}
          </div>
          <p>{description}</p>
